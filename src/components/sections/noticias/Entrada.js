            ...
            <Container>
                <Grid container spacing={4}>
                    ...
                    <div className="entrada-contentwrap">
                        ...
                        <p className="entrada-date small">
                            30 de Marzo, 2020
                        </p>
                        <Divider style={{marginTop: 12, marginBottom: 12, marginLeft: 16, marginRight: 16}}/>
                    ...
                    <Grid item xs={12} md={3}>
                        <div className="postsrecientes-paper">
                            ...
                            <Divider style={{marginBottom: 18, marginLeft: 12, marginRight: 12}}/>
